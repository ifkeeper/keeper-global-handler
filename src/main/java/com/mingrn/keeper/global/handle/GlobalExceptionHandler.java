...
import com.mingrn.keeper.global.util.RequestUtils;
...
public class GlobalExceptionHandler extends AbstractErrorController {
    ...
    public Result assertionError(HttpServletRequest request, Exception e) {
        LOGGER.error("!!! request uri:{} from {} assertion error", request.getRequestURI(), RequestUtils.getIpAddress(request), e);
