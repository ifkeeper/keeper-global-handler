 ...
 * 当请求进入方法体之前会在 {@link com.mingrn.keeper.global.aspect.ParamsIsNotNullAspect}
 * 中进行校验。若被 <code>@ParamsIsNotNull</code> 注解标识的参数值为 NULL 或 '' 时,会抛出
 * {@link com.mingrn.keeper.global.exception.ParamIsNotNullException} 异常,并会
 * 在全局异常处理{@link com.mingrn.keeper.global.handle.GlobalExceptionHandler#paramIsNotNullException(HttpServletRequest, Exception)}中被拦截。
 * </p>
